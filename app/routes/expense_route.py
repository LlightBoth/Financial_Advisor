...
def detail(expense_id):
    ...
    expense = ExpenseServices.get_expense_id(expense_id)
...
def create():
    ...
    if form.validate_on_submit():
        ...
        flash(
            f"Expense '{expense.amount}' created successfully!",
            "success"
        )
...
def edit(expense_id):
    ...
    if form.validate_on_submit():
        ...
        flash(
            f"Expense '{expense.amount}' updated successfully!",
            "success"
        )
...
def delete(expense_id):
    ...
    if form.validate_on_submit():
        ...
        flash(
            "Invalid CSRF token or delete request.",
            "danger"
        )
